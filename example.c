/*
This is a very slightly modified version of `core_custom_frame_control.c` that plays a FLAC every time the circle hits the edge of the screen.
Requires the following compile flags:
    -DSUPPORT_CUSTOM_FRAME_CONTROL -DSUPPORT_FILEFORMAT_FLAC
*/
...
int main(void)
{
    ...
    // FLAC to play each loop
    Sound flac = LoadSound("44429__thecheeseman__hurt2.flac");
    //--------------------------------------------------------------------------------------
